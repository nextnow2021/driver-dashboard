...
<html>
  <head>
    ...
    <title>Qubotel Admin Panel</title>
        ...
        <ul class="ml-auto d-flex align-items-center list-unstyled mb-0">
         ...
         <!--  <li class="nav-item dropdown mr-3"><a id="notifications" href="http://example.com" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link dropdown-toggle text-gray-400 px-1"><i class="fa fa-bell"></i><span class="notification-icon"></span></a>
          ...
          <li class="nav-item dropdown ml-auto"><a id="userInfo" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link dropdown-toggle"><img src="img/favicon1.png" alt="Moin Shaikh" style="max-width: 2.5rem;" class="img-fluid rounded-circle bg-white shadow"></a>
            <div aria-labelledby="userInfo" class="dropdown-menu"><a href="" class="dropdown-item"><strong class="d-block text-uppercase headings-font-family">Moin Shaikh</strong><small>Web Developer</small></a>
              <div class="dropdown-divider"></div><a href="#" class="dropdown-item">Settings</a><a href="#" class="dropdown-item">Activity log       </a>
              <div class="dropdown-divider"></div><a href="../login/login.php" class="dropdown-item">Logout</a>
            </div>
          </li>
        </ul>
      </nav>
    ...
    <div class="d-flex align-items-stretch">
      <div id="sidebar" class="sidebar py-3">
        ...
        <ul class="sidebar-menu list-unstyled">
              ...
              <li class="sidebar-list-item"><a href="foodorder.html" class="sidebar-link text-muted"><i class="o-sales-up-1 mr-3 text-gray"></i><span>Food Order</span></a></li>
              <li class="sidebar-list-item"><a href="mytrips.html" class="sidebar-link text-muted"><i class="o-table-content-1 mr-3 text-gray"></i><span>My Trips</span></a></li>
              ...
              <li class="sidebar-list-item"><a href="mywallet.html" class="sidebar-link text-muted"><i class="o-survey-1 mr-3 text-gray"></i><span>My Wallet</span></a></li>
              <li class="sidebar-list-item"><a href="roomservice.html" class="sidebar-link text-muted"><i class="o-survey-1 mr-3 text-gray"></i><span>Room Service</span></a></li>
              ...
              <li class="sidebar-list-item"><a href="support.html" class="sidebar-link text-muted"><i class="o-survey-1 mr-3 text-gray"></i><span>Support</span></a></li>
          <!-- <li class="sidebar-list-item"><a href="#" data-toggle="collapse" data-target="#pages" aria-expanded="false" aria-controls="pages" class="sidebar-link text-muted"><i class="o-wireframe-1 mr-3 text-gray"></i><span>Pages</span></a>
            <div id="pages" class="collapse">
              ...
              <li class="sidebar-list-item"><a href="mydocument.php" class="sidebar-link text-muted"><i class="o-exit-1 mr-3 text-gray"></i><span>My Document</span></a></li>
        </ul>
              ...
              <div class="col-xl-3 col-lg-3 mb-4 mb-xl-0">
                <div class="bg-white shadow roundy p-4 h-100 d-flex align-items-center justify-content-between tabs-title">
                  <div class="flex-grow-1 d-flex align-items-center">
                    ...
                    <div class="text ">
                      <h6 class="mb-0"><a href="">My Trip</a></h6>
                    </div>
                  </div>
              ...
              <div class="col-lg-12 mb-4 mb-lg-0">
                <div class="card">
                  <div class="card-header">
                    <h2 class="h6 text-uppercase mb-0">Error</h2>
                  </div>
                  <div class="card-body">
                ...
                <div class="error-actions">
                    <a href="index.php" class="btn btn-primary btn-lg"><span class="glyphicon glyphicon-home"></span>
                        Take Me Home </a><a href="index.php" class="btn btn-primary btn-lg"><span class="glyphicon glyphicon-envelope"></span> Contact Support </a>
                </div>
            </div>
                  </div>
                </div>
          ...
          <div class="container-fluid">
            <div class="row">
              <div class="col-md-6 text-center text-md-left text-primary">
                <p class="mb-2 mb-md-0">Qubotel &copy; 2020</p>
              </div>
              <div class="col-md-6 text-center text-md-right text-gray-400">
                <p class="mb-0">Design by <a href="" class="external text-gray-400">MilesAhead Tech Pvt Ltd.</a></p>
