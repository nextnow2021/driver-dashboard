...
class AdminDocumentClass extends connectionClass
{
 ...
 //        echo("<meta http-equiv='refresh' content='0'>"); //Refresh by HTTP 'meta'
	...
	public function Adminlistdocument(){
    ...
    //  WHERE login_id = $login_id');
        ...
        $sql = "SELECT *  FROM `driver_document`";
        echo "$sql";
...
class AdminVehicleClass extends connectionClass
{
    ...
    public function Adminlistvehicle()
    {
        ...
        $login_id = $_SESSION["uid"];
         $sql = "SELECT *  FROM `vehicle_document`";
        echo "$sql";
        $res = mysqli_query($this->con,$sql);
        return $res;
...
class AdminDocSummaryClass extends connectionClass{
    ...
    // }
     ...
     public function Adminlistdocsummary()
    {

        //$login_id = $_SESSION["uid"];
         // $sql = "SELECT *  FROM `doc_summary` where login_id=$login_id";
    	$sql = "SELECT *  FROM `doc_summary`";
        echo "$sql";
        $res = mysqli_query($this->con,$sql);
        return $res;
