      ...
      <div id="sidebar" class="sidebar py-3">
        <div class="text-gray-400 text-uppercase px-3 px-lg-4 py-4 font-weight-bold small headings-font-family">MAIN</div>
         <ul class="sidebar-menu list-unstyled">
              ...
              <li class="sidebar-list-item"><a href="support.php" class="sidebar-link text-muted active">
              ...
              <div class="col-xl-3 col-lg-3 mb-4 mb-xl-0">
                <div class="bg-white shadow roundy p-4 h-100 d-flex align-items-center justify-content-between tabs-title">
                  <div class="flex-grow-1 d-flex align-items-center">
                    ...
                    <div class="text ">
                      <h6 class="mb-0">Support Forum</h6><!-- <span class="text-gray">145,14 GB</span> -->
                    </div>
                  </div>
            ...
            <div class="row">
              <div class="col-lg-6">
                <div class="mb-5 mb-lg-0">         
                  ...
                  <div >
                    <h1 class="text-black mb-5 ">Our professional Support Staffs <br/>are always ready <br/>to support you</h1>
              ...
              <div class="col-lg-6">
                <div class=" mb- mb-lg-0">         
                  ...
                  <div >
                    <p class="text-black mb-5">Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo. <br/> <br/>
            ...
            <div class="row mb-4">
              <div class="col-lg-12 mb-4 mb-lg-0">
                <div class="card">
                  <div class="card-header">
                    <nav>
                    <div class="bg-white shadow roundy p-4 h-100 d-flex align-items-center justify-content-between tabs-title nav-item" >
                ...
                <div class=" mb- mb-lg-0">         
                  ...
                  <div >
                    <p class="text-black mb-5 "> <br/> <br/>
                      <strong>NextNow Johannesburg Office.
                      Old Mutual Square
                      6-8 West Road South,
                      Morningside Sandton, 2057.</strong>
                     </p>
                    <!-- <div class="d-flex justify-content-between align-items-start align-items-sm-center mb-4 flex-column flex-sm-row">
                      <div class="left d-flex align-items-center">
                        <div class="icon icon-lg shadow mr-3 text-gray"><i class="fab fa-dropbox"></i></div>
